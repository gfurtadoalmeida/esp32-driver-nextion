...
extern "C"
{
     ...
     * @param handle Nextion context pointer.
     * @param component_name_or_id A null-terminated string with the component's name or id.
     * @param is_visible True make it visible; false make it invisible.
     *
     * @return NEX_OK or NEX_FAIL | NEX_DVC_ERR_INVALID_COMPONENT.
     */
     ...
     *
     * @param handle Nextion context pointer.
     * @param is_visible True make them visible; false make them invisible.
     *
     ...
     * @param handle Nextion context pointer.
     * @param component_name_or_id A null-terminated string with the component's name or id.
     * @param is_touchable True make it touchable; false make it untouchable.
     *
     * @return NEX_OK or NEX_FAIL | NEX_DVC_ERR_INVALID_COMPONENT.
     */
     ...
     *
     * @param handle Nextion context pointer.
     * @param is_touchable True make them touchable; false make them untouchable.
     *
     * @return NEX_OK or NEX_DVC_ERR_INVALID_COMPONENT.
     */
