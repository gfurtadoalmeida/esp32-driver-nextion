#ifndef __ESP32_DRIVER_NEXTION_PROTO_PRSR_EVT_SENDME_H__
#define __ESP32_DRIVER_NEXTION_PROTO_PRSR_EVT_SENDME_H__
...
extern "C"
{
     ...
     */
    bool parser_evt_sendme_parse(const parser_t *parser, const uint8_t *data, size_t length);
