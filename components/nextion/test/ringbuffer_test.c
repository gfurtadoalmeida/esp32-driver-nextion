...
#define FILL(ring, length)           \
    ...
    TEST_CASE("Creation is correct", "[ringbuffer]")
    {
    ...
    TEST_CASE("Reset is correct", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
    ...
    TEST_CASE("Full is correct", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
    ...
    TEST_CASE("Remaining reduces when writing", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
    ...
    TEST_CASE("Remaining increases when reading", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
        uint8_t buffer[3];
    ...
    TEST_CASE("Can write when not full", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
    ...
    TEST_CASE("Cannot write when full", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
    ...
    TEST_CASE("Can write bytes when not full", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
    ...
    TEST_CASE("Cannot write bytes when full", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
        uint8_t buffer[2] = {1, 2};
    ...
    TEST_CASE("Cannot write bytes when no space for all bytes", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
        uint8_t buffer[2] = {1, 2};
    ...
    TEST_CASE("Can read when not emtpy", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
    ...
    TEST_CASE("Cannot read when emtpy", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
        uint8_t value;
    ...
    TEST_CASE("Can read bytes when not emtpy", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
        uint8_t buffer[2];
    ...
    TEST_CASE("Cannot read bytes when emtpy", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
        uint8_t buffer[2];
    ...
    TEST_CASE("Cannot read bytes when not enough bytes written", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
        uint8_t buffer[2];
    ...
    TEST_CASE("What was written is correctly read", "[ringbuffer]")
    {
        ringbuffer_handle_t ring = ringbuffer_create(5);
        uint8_t buffer[5];
